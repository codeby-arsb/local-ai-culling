    ...
    try:
        ...
        if results.face_landmarks:
            ...
            for idx, face_landmarks in enumerate(results.face_landmarks):
                ...
                eye_state, eye_score, expr_type, expr_conf = (
                    "Unknown",
                    0.0,
                    "Unknown",
                    0.0,
                ...
                if results.face_blendshapes and idx < len(results.face_blendshapes):
                    ...
                    eye_state, eye_score, expr_type, expr_conf = analyze_blendshapes(
                        blendshapes
                    )
            ...
            record.largest_face_ratio = (
                (best_area / (img_w * img_h)) if img_w * img_h > 0 else 0.0
            )
        ...
        logger.error(
            f"Module 'FaceEyeAnalysis' failed on '{record.filename}'. Reason: {str(e)}. Action: Skipping face/eye analysis."
        )
